...
<!-- Javascript Search Funtion -->
<script language="javascript">
function myFunction() {
  var input, filter, table, tr, td, i, t; //Table variables
...
<body>
<h1>Insurance Plans and Coverage</h1>
<div class="fusion-table table-1">
<input type="text" id="myInput" onKeyUp="myFunction()" placeholder="Search"> 
<table width="100%">
  <thead>
   <tr>
   <th style="background-color:#06F; color: #fff; width: 371px;">Payor Name</th>
   <th style="background-color: #06F; color: #fff; width: 258px;">MSO or Affiliated Health Plan</th>
   <th style="background-color: #06F; color: #fff; width: 193px;">Contract Type</th>
   <th style="background-color: #06F; color: #fff;">Entities</th>
  </tr>
  </thead>
</table>
<table width="100%" id="myTable">
 <tr>
  ...
  <td>Los Angeles, San Diego, Orange County, San Bernardino</td>
  </tr>
  <tr>
  ...
  <td>San Diego, Orange Countym, San Bernardino</td>
  </tr>
  <tr>
  <td width="371">All Care Medical Group</td>
  <td width="258">&nbsp;</td>
  <td width="193">MG/IPA</td>
  <td>Orange County Only</td>
  </tr>
  <tr>
  <td width="371">Alliance IPA</td>
  <td width="258">Healthcare Partners</td>
  <td width="193">MG/IPA</td>
  <td>San Diego, Orange County, San Bernardino</td>
  </tr>
  <tr>
  ...
  <td width="258">&nbsp;</td>
  <td width="193">HMO - Medi-Cal</td>
  <td>Los Angeles, San Diego, Orange County, VHH</td>
  </tr>
  <tr>
  <td width="371">LA County Mental Health, Medi-Cal and Medicare</td>
  <td width="258">&nbsp;</td>
  <td width="193">Government</td>
  <td>San Bernardino Only</td>
  </tr>
  <tr>
  ...
  <td width="258">Health Net</td>
  <td width="193">PPN</td>
  <td>Los Angeles, Orange County</td>
  </tr>
  <tr>
  ...
  <tr>
  <td width="371">San Bernardino Hills Medical Group</td>
  <td width="258">Heritage Provider Network</td>
  <td width="193">MG/IPA</td>
  <td>San Diego, Orange County, San Bernardino</td>
  </tr>
